...
} = require("../controllers/registration/completePatProfile.js");
const {
    loginUser,
    generateToken
} = require("../controllers/login/login.js");
const {
    verifyToken
} = require("../controllers/login/verifyToken.js")
const {
    completeDoctorProfile
} = require("../controllers/registration/completeDocProfile.js");
...
const {
    uploadBankDetails,
    getBankDetails
} = require("../controllers/registration/uploadBankDetails.js")
...
router.get("/get/bank-details", protect, getBankDetails)
