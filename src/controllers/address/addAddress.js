...
const addAddress = async(req, res)=>{
    ...
    await address.create({user_id : id, country : country, state: state, city: city, pincode : pincode, street: street, landmark: landmark, house_no: houseNo, delivery_name: deliveryName, delivery_pno: deliveryPNo})
